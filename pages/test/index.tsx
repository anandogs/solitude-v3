  ...
  return (
    <div className="bg-primary-brand w-screen flex h-[30.625rem]">
      ...
      <div className="bg-tertiary-brand w-[33%] px-[2.75rem]">
        ...
        <form className="grid pt-[2.875rem] gap-y-[1.5625rem]">
          <div className="flex gap-x-[5%]">
            <input type='text' placeholder="First name" className="placeholder:text-secondary-brand w-[35%]"/>
            <input type='text' placeholder="Last name" className="placeholder:text-secondary-brand w-[60%]"/>
          </div>
          <input type='email' placeholder="Email address" className="placeholder:text-secondary-brand"/>
